...
################   #####################################
    ...
    qa_chain = RetrievalQA.from_chain_type(
        llm=llm_gemini_instance, # Qwen 2.5 14B via Ollama local
    ...
    result = qa_chain.invoke("dame los contactos que dice el documento con toda la informacion disponible?")
