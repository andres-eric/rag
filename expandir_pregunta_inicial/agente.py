...
#La reclasificación es un paso de posprocesamiento que puede seguir a cualquier método de recuperación, incluida la recuperación híbrida
#Primero, se recupera un conjunto más grande de documentos candidatos.
#Se aplica un modelo más sofisticado para volver a puntuar los documentos.
#Se reordenan en base a estas puntuaciones de relevancia más precisas
